...
THEME_VARIABLES = {
    ...
    "template_name": "Smart Inventory Control",
    "template_suffix": "",
    "template_version": "1.0.0",
    "template_free": False,
    "template_description": "O Aitigos é a plataforma inteligente que facilita a gestão de stock do seu negócio de vestuário, integrando-se perfeitamente com Shopify e Moloni, enquanto utiliza inteligência artificial para otimizar processos, prever necessidades e maximizar os resultados com recomendações automáticas.",
    "template_keyword": "Controlo de Estoque, Integração com Shopify e Moloni, Inteligência Artificial para Automação, Previsão de Reposição, Análise de Inventário",
    "facebook_url": "",
    "twitter_url": "",
    "github_url": "",
    "dribbble_url": "",
