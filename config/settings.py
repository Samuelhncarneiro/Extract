...
ALLOWED_HOSTS = [
    "localhost", 
    "127.0.0.1",
    "aitigos.com",  # Novo domínio
    "www.aitigos.com"  # Subdomínio www
]


CSRF_TRUSTED_ORIGINS = [
    "http://aitigos.com",  # Novo domínio
    "https://aitigos.com",  # Novo domínio com HTTPS
    "https://www.aitigos.com"  # Subdomínio www com HTTPS
]

MOLONI_REDIRECT_URI = 'https://aitigos.com/moloni/callback-moloni/'
...
LOGGING = {
    ...
    'handlers': {
        'console': {
            ...
            'formatter': 'verbose',  # Use 'json' para logs JSON
        },
    },
    'loggers': {
        'django': {
